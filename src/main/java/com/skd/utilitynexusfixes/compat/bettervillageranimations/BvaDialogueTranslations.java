package com.skd.utilitynexusfixes.compat.bettervillageranimations;
    ...
    public static void reload(ResourceManager resourceManager) {
        ...
        try {
            ...
            try (Reader reader = new InputStreamReader(resource.get().open(), StandardCharsets.UTF_8)) {
                ...
                LOGGER.info("[utility_nexus_fixes] Loaded {} Better Villager Animations dialogue translations",
                    TRANSLATIONS.size());
            }
        } catch (Exception e) {
            TRANSLATIONS = Collections.emptyMap();
            if (!LOAD_FAILURE_LOGGED) {
                ...
                LOGGER.warn("[utility_nexus_fixes] Failed to load Better Villager Animations translations from {}: {}",
