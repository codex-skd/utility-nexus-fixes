package com.skd.utilitynexusfixes.log;
...
public class BenignLogFilter extends AbstractFilter {
    ...
    private Result check(String formattedMessage, String loggerName) {
        ...
        if (!UNFConfig.enabled()) {
            return Result.NEUTRAL;
        }
        if (loggerName != null && loggerName.startsWith("com.skd.utilitynexusfixes")) {
            return Result.NEUTRAL;
        }
        List<String> patterns = UNFConfig.patterns();
